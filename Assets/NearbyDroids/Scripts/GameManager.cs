...
namespace NearbyDroids
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        {
            ConsoleLog.SLog("Intializing managerImpl as Remote");
        ...
        internal void CreatePlayerScorePanel(PlayerInfo playerInfo)
        {
            ...
            if (scorePanel == null)
            {
                ConsoleLog.SLogError("Score Panel cannot be null!");
                return;
            }
            ...
            if (playerInfo.ScoreText == null || playerInfo.NameText == null)
            {
                ...
                if (texts == null)
                {
                    ConsoleLog.SLog("Found no text components?!?!?!");
                }
            ...
            {
                ConsoleLog.SLog("Did not find name text field?");
            }

            if (playerInfo.ScoreText == null)
            {
                ConsoleLog.SLog("Did not find score text field?");
            }
        ...
        {
            ConsoleLog.SLog("Let the " + type + " game begin!");
        ...
        internal void RefreshPlayers()
        {
            ...
            {
                ConsoleLog.SLog("Got the info player: " + player.Player.Name);
                ...
                if (playerObj != null)
                {
                    ...
                    {
                        ConsoleLog.SLog("Can't find playercontroller??!?!?");
                    }
                }
                else
                {
                    ConsoleLog.SLog("Cannot find gameobject for " + player.DeviceId);
                }
            }
        }
        ...
        internal void OnLevelWasLoaded(int sceneIndex)
        {
            ...
            if (sceneIndex == 1)
            {
                if (Room != null)
                {
                    ConsoleLog.SLog("Setting Room level callbacks");
        ...
        {
            ConsoleLog.SLog("OnRoomJoined Called status: " + response.ResponseStatus);
        ...
        public void OnObjectChanged(Shareable o)
        {
            ...
            {
                ConsoleLog.SLog("Trying to record null object change?");
            }
        }
        ...
        public void NotifyChanges()
        {
            if (Room != null)
            {
                if (changesToShare.Count != 0)
                {
                    ...
                    {
                        ConsoleLog.SLog("-->" + s.Name + " at " + s.Position);
                    }

                    ConsoleLog.SLog("Sending " + changesToShare.Count + " changes!");
            ...
            {
                ConsoleLog.SLog("Not a multiplayer game, notification not sent.");
            }
        }
        ...
        internal void Update()
        {
            ...
            {
                ConsoleLog.SLog("Skipping managerImpl.OnUpdate, impl is null");
            }
        ...
        internal void UpdateScores()
        {
            ...
            foreach (PlayerInfo p in PlayerInfo.AllPlayers)
            {
                ...
                {
                    ConsoleLog.SLog("Score prefab not set for " + p.Player.Name);
                }
            }
        ...
        internal byte[] GetGameStateData(GameStateData.Phase phase)
        {
            ...
            ConsoleLog.SLog("Serializing Game state: " + phase + " " + gameState.SerialNumber);
        ...
        public void SendToAll(byte[] message)
        {
            ...
            {
                ConsoleLog.SLog("No Remote endpoints for getting updates!");
            }
        }
        ...
        internal void UpdateGameStateFromData(byte[] data)
        {
            ...
            ConsoleLog.SLog("Received new GameState!( " + msg.Changes.Count + ")");
        ...
        {
            ConsoleLog.SLog("Player " + player.Name + " " + (string)(present ? "Arrived" : "Left"));
