...
namespace NearbyDroids
{
    ...
    public class NearbyRoom : IMessageListener
    {
        ...
        public static void FindRooms(Action<NearbyRoom, bool> callback)
        {
			...
			ConsoleLog.SLog("Calling StartDiscovery");
        ...
        {
            ConsoleLog.SLog("Advertising Room: " + Name);
            ...
            PlayGamesPlatform.Nearby.StartAdvertising(
                ...
                OnAdvertisingResult,
                OnConnectionRequest);
            ConsoleLog.SLog("Advertising: " + PlayGamesPlatform.Nearby.GetAppBundleId());
        }
        ...
        {
            ConsoleLog.SLog("Closing Room " + Name);
        ...
        {
            ConsoleLog.SLog("OnAdvertisingResult: " + result);
        }
        ...
        internal void OnConnectionRequest(ConnectionRequest request)
        {
            ...
            if (AutoJoin)
            {
                ConsoleLog.SLog("Automatically connecting to " + request.RemoteEndpoint);
        ...
        {
            ConsoleLog.SLog("RECEIVED Message from " + remoteEndpointId);
            ...
            {
                ConsoleLog.SLog("Messagehandler not set, ignoring!");
            }
        }
        ...
        internal class RoomListener : IDiscoveryListener
        {
            ...
            public void OnEndpointFound(EndpointDetails discoveredEndpoint)
            {
                ...
                {
                    ConsoleLog.SLog("Invoking roomCallback.");
                    roomDiscoveredCallback.Invoke(room, true);
                }
                else
                {
                    ConsoleLog.SLog("No roomCallback configured.");
                }
            }
