...
namespace NearbyDroids
{
    ...
    public class NearbyPlayer
    {
        ...
        public NearbyPlayer(string name)
        {
            ...
            {
                ConsoleLog.SLog("Whoa!!! Nearby is null!");
                did = "local";
                eid = "local";
            }
            else
            ...
            ConsoleLog.SLog("Creating local player " + name + "@" + deviceId + ":" + endpointId);
        }
        ...
        {
            ConsoleLog.SLog("Creating player " + name + "@" + deviceId + ":" + endpointId);
            this.name = name;
