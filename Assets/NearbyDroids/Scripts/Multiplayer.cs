        ...
        public void EnterRoom()
        {
            ...
            else
            {
                if (!GameManager.Instance.Room.AutoJoin)
                {
                    ...
                    ConsoleLog.SLog("Checking " + players.Length + " players");
                    foreach (Toggle t in players)
                    {
                        if (!t.isOn)
                        {
                            ConsoleLog.SLog("Removing " + t.gameObject.name);
                            PlayerInfo.RemovePendingPlayer(t.gameObject.name);
                        }
                        else
                        {
                            ConsoleLog.SLog("Accepting " + t.gameObject.name);
                            ...
                            {
                                ConsoleLog.SLogError("Cannot find NearbyPlayer for " +
                                    t.gameObject.name);
                            }
                        }
                    }
